...
class AVLTree(object):
    ...
    def inPosOrder(self):
        elements = []
        self._inPosOrderRecursively(self.root, elements)
        return elements
    
    def _inPosOrderRecursively(self, root, elements):
        if root:
            self._inPosOrderRecursively(root.left, elements)
            self._inPosOrderRecursively(root.right, elements)
